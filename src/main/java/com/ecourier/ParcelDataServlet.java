...
@WebServlet("/ParcelDataServlet")
public class ParcelDataServlet extends HttpServlet {
    /**
	 * 
	 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (Connection connection = DBConnectivity.getConnection()) {
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(query);
                ...
                while (resultSet.next()) {
                    ...
                    parcel.setSenderPhone(resultSet.getString("senderPhone"));
                    parcel.setSenderAddress(resultSet.getString("senderAddress"));
                    parcel.setReceiverName(resultSet.getString("recName"));
                    parcel.setReceiverPhone(resultSet.getString("recPhone"));
                    parcel.setReceiverAddress(resultSet.getString("recAddress"));
                    parcel.setParcelType(resultSet.getString("parcelType"));
                    parcel.setParcelWeight(resultSet.getString("parcelWeight"));
                    parcel.setTotalPrice(resultSet.getString("totprc"));
                    parcel.setPayment(resultSet.getString("payment"));
        ...
        String json = getJsonString(parcels);
